...
class Agent::Chooser < ChatGptAgent
  ...
  def setup_agent_config_from_options
    ...
    define_parameter('classify_request', 'result', enum: options.keys, description: 'Your guess at which option best fits the user input.')
  end
